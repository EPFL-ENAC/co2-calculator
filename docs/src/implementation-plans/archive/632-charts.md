...
title: "Updated Charts Implementation Plan"
summary: "For modules with a single XX category (e.g., Equipment), the chart shows one bar with YY subcategories as segments."
---
