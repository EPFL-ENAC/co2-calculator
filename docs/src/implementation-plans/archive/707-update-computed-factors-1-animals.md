...
title: "Plan: 707 — Implement sync_module_factors (Backend only)"
summary: "Using example of Research facilities module, this feature aims at allowing a backoffice manager to update factors that are already stored in the database. The update logic is module data entry type dependent."
---
