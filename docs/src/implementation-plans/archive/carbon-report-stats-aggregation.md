...
title: "Carbon Report Stats Aggregation Implementation"
summary: "Added a stats column to the CarbonReport model that aggregates emission statistics from all child CarbonReportModule records, similar to the existing module-level stats."
---
