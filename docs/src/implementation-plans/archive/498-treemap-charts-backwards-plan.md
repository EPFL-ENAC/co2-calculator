...
title: "Treemap Charts Revert — Implementation Plan"
summary: "The endpoint response shape stays as defined in 252-chart-results-endpoint.md. No new keys are added."
---
