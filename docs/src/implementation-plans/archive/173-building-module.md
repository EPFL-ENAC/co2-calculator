...
title: "Plan: Buildings Module (Task 173)"
summary: "The Buildings module (infrastructure, moduletypeid=3) exists only as a skeleton: enum stubs, a minimal frontend config, and is blocked behind forbiddenModules in the UI. This plan implements it fully per the success..."
---
