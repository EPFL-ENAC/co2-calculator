...
title: "Emission Type Subcategory Granularity"
summary: "The current EmissionType hierarchy for Buildings is not granular enough. It needs a ZZ item level (room type) beneath each YY subcategory (energy type). Purchases also needs a new category."
---
