...
title: "Implementation Plan: Student FTE Calculator Helper"
summary: "Add calculator helper to student headcount form. Formula: (students × duration × avgfte) / 12 = Annual FTE. Button adds result to Total Student FTE input."
---
