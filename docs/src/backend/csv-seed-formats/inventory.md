...
| `processemissions_data.csv`           | `unit_institutional_id`, `category`, `subcategory`, `quantity_kg`, `note`, `kg_co2eq`                                                                                                                          |
...
| `processemissions_test.csv`              | `category`, `subcategory`, `quantity_kg`, `note`                                                                                                                          |
