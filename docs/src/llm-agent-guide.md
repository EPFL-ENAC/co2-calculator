...
| Adding a permission            | [`backend/06-PERMISSION-SYSTEM.md`](./backend/06-PERMISSION-SYSTEM.md)                                                            |
...
| Role sync (on session renewal) | [`role-sync-architecture.md`](https://github.com/epfl-enac/co2-calculator/blob/main/docs/role-sync-architecture.md)               |
