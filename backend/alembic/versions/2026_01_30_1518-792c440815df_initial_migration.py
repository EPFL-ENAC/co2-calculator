...
Revision ID: 792c440815df
Revises:
Create Date: 2026-01-30 15:18:30.443224
...
revision: str = "792c440815df"  # noqa: F841
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_by", sa.Integer(), nullable=True),
        sa.Column("updated_by", sa.Integer(), nullable=True),
        sa.Column("transport_mode", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
