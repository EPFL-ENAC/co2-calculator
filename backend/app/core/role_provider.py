...
class RoleProvider(ABC):
    ...
    @abstractmethod
    async def get_roles(self, userinfo: Dict[str, Any], sciper: str) -> List[Dict[str, Any]]:
    ...
    async def get_roles(self, userinfo: Dict[str, Any], sciper: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if not authorizations:
                logger.info(
                    "No authorizations found in Accred API",
                    extra={"sciper": sciper}
                )
                return []
            ...
            logger.error(
                ...
                extra={"sciper": sciper, "error": str(e)}
            )
            return []
