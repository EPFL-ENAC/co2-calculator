...
export default {
  ...
  // module member
  [`${MODULES.Headcount}-member-form-field-institutional-id-label`]: {
    en: 'Institutional ID',
    fr: 'Identifiant institutionnel',
  },
  ...
  [`${MODULES.Headcount}-member-form-field-position-label`]: {
    en: 'Position Category',
    fr: 'Catégorie de poste',
  },
  ...
  [`${MODULES.Headcount}-student-helper-avg-fte-error`]: {
    en: 'Average FTE per student must be between 0 and 1.',
    fr: "L'EPT moyen par étudiant doit être compris entre 0 et 1.",
  },
  [`${MODULES.Headcount}-position-student`]: {
    en: 'Student',
    fr: 'Étudiant',
  },
  [`${MODULES.Headcount}-position-professor`]: {
    en: 'Professor',
    fr: 'Professeur',
  },
  [`${MODULES.Headcount}-position-scientific-collaborator`]: {
    en: 'Scientific Collaborator',
    fr: 'Collaborateur scientifique',
  },
  [`${MODULES.Headcount}-position-postdoctoral-assistant`]: {
    en: 'Postdoctoral Assistant',
    fr: 'Assistant postdoctoral',
  },
  [`${MODULES.Headcount}-position-doctoral-assistant`]: {
    en: 'Doctoral Assistant',
    fr: 'Assistant doctorant',
  },
  [`${MODULES.Headcount}-position-trainee`]: {
    en: 'Trainee',
    fr: 'Stagiaire',
  },
  [`${MODULES.Headcount}-position-technical-administrative-staff`]: {
    en: 'Technical/Administrative Staff',
    fr: 'Personnel technique/administratif',
  },
  [`${MODULES.Headcount}-position-other`]: {
    en: 'Other',
    fr: 'Autre',
  },
} as const;
