export default {
  ...
  backoffice_reporting_module_status_label: {
    ...
    fr: 'Filtrer par statut des modules ({count})',
  },
  ...
  backoffice_reporting_generate_usage_description: {
    ...
    fr: "Rapports sur l'utilisation du calculateur : laboratoires ayant terminé les modules, activité des utilisateurs, statut des saisies et taux d'achèvement.",
  },
