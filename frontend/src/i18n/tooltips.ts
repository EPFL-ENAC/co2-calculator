export default {
  ...
  'module-purchase-submodule-scientific_equipment-form': {
    en: "Please add any missing scientific equipment purchases to the list above. The item description, UNSPSC category (typology), and total amount spent are mandatory. If you use a CSV, check the column headers: purchase_institutional_code is the UNSPSC code (e.g. 43211500, then the corresponding description is shown as 'UNSPSC description' in the table), and purchase_additional_code corresponds to the NACRES code. For more information, please refer to the documentation: Modules specification.",
    fr: "Veuillez ajouter les achats d'équipements scientifiques manquants dans la liste ci-dessus. La description de l'article, la catégorie UNSPSC (typologie) et le montant total dépensé sont obligatoires. Si vous utilisez un CSV, vérifiez les en-têtes de colonnes : purchase_institutional_code est le code UNSPSC (ex. 43211500 ; la description correspondante s’affiche alors comme « Description UNSPSC » dans le tableau), et purchase_additional_code correspond au code NACRES. Pour plus d’informations, consultez la documentation : Spécification des modules.",
  },
  ...
  'results-reduction-process_emissions': {
  ...
  'results-reduction-buildings_room': {
    en: 'Low effort: switching off lighting in unused spaces. Middle of the road: adjusting temperature setpoints, reducing services outside occupied periods, increasing renewable sourcing. High effort: optimizing according to occupancy, identify inefficient operations, maximizing renewable sourcing. Ambitious: systematic elimination of unnecessary energy use.',
    fr: 'Faible effort : éteindre l’éclairage dans les espaces inutilisés. Voie intermédiaire : ajuster les températures et réduire les services hors occupation. Effort élevé : optimiser les services selon l’occupation et identifier les usages inefficaces. Ambitieux : éliminer systématiquement les consommations énergétiques inutiles.',
  },
  ...
  'results-reduction-research_facilities': {
    en: 'Low effort: improve scheduling of facility resources... Middle of the road: ...and research facilities reduce process emissions impact... High effort: ... and research facilities organize repair-reuse workshops, reducing purchases impact... Ambitious: ...and efficient centralization of resources, reducing overall operations impact.',
    fr: 'Faible effort : améliorer la planification des ressources des plateformes... Voie intermédiaire : ... et réduire l’impact des émissions liées aux procédés... Effort élevé : ... et organiser des ateliers de réparation et de réemploi pour réduire les émissions liées aux achats... Ambitieux : ... et augmenter les achats centralisés et la mutualisation des équipements, pour réduire toutes émissions liées aux opérations.',
  },
  'results-reduction-commuting': {
    en: 'Low effort: 1–2 remote-working days per week, promote public-transport subscriptions. Middle of the road: increase public transportation subsidies. High effort: reduce staff commuting by car through parking restrictions/car-pooling incentives. Ambitious: extremely reduced parking on site, generalized car-sharing, public transports, biking and walking are the main means.',
    fr: 'Faible effort : 1–2 jours de télétravail par semaine, promouvoir les abonnements aux transports publics. Voie intermédiaire : augmenter les subventions aux transports publics. Effort élevé : réduire les déplacements pendulaires en voiture en instaurant des restrictions de stationnement et/ou des incitations au covoiturage. Ambitieux : réduction très importante du stationnement sur site ; covoiturage généralisé ; les transports publics, le vélo et la marche deviennent les principaux modes de déplacement.',
  },
  'results-reduction-food': {
    en: 'Low effort: favor local and seasonal sourcing. Middle of the road: plant-based meals as default. High effort: strong restriction of high-impact meats. Ambitious: food waste minimized through redistribution, restaurants respect a yearly carbon budget.',
    fr: 'Faible effort : privilégier les produits locaux et de saison. Voie intermédiaire : proposer les repas végétaux par défaut. Effort élevé : fortement limiter les viandes à fort impact. Ambitieux : réduire le gaspillage par la redistribution et critères bas-carbone obligatoires.',
  },
  'results-reduction-waste': {
    en: 'Low effort: better sorting and improve recycling. Middle of the road: systemic waste prevention, increasing reuse/sorting. High effort: waste reduction as part of the institutions strategy. Ambitious: near-zero-waste approach and prioritizing circular practices across activities.',
    fr: 'Faible effort : améliorer le tri et le recyclage. Voie intermédiaire : systématiser la prévention, le réemploi et le tri. Effort élevé : intégrer la réduction des déchets à la stratégie institutionnelle. Ambitieux : viser le quasi-zéro déchets et généraliser les pratiques circulaires.',
  },
