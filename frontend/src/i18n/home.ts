export default {
  ...
  home_intro_1_link_url: {
    en: 'https://ghgprotocol.org/corporate-standard',
    fr: 'https://ghgprotocol.org/corporate-standard',
  },
  home_intro_1_part_2: {
    en: '), the international standard for calculating greenhouse gas emissions.',
