...
export const element: Record<string, ColorColumn> = {
  'charts-unit-gas-category': chartColorScale[15],
  'charts-infrastructure-gas-category': chartColorScale[15],
  'charts-infrastructure-category': chartColorScale[5],
  'charts-equipment-category': chartColorScale[4],
  'charts-commuting-category': chartColorScale[8],
  'charts-food-category': chartColorScale[9],
  'charts-professional-travel-category': chartColorScale[7],
  'charts-it-category': chartColorScale[15],
  'charts-research-core-facilities-category': chartColorScale[9],
  'charts-purchases-category': chartColorScale[10],
  'charts-waste-category': chartColorScale[11],
  'charts-grey-energy-category': chartColorScale[6],
  'charts-equipment-electric-consumption-category': chartColorScale[4],
  'charts-internal-services-category': chartColorScale[1],
  'charts-external-cloud-category': chartColorScale[3],
  'charts-purchase-category': chartColorScale[10],
};

// Export elementIds for reuse in components
