export const csvBuildingsCombustionContent =
...
export const csvHeadcountContent =
  'name,position_title,position_category,user_institutional_id,fte,note \nPeter,Professor,professor,150322,1.00, \nHirling,Technical adjoint,technical_administrative_staff,150333,1.00,\n Michel,Infrastructure manager,scientific_collaborator,150356,1.00,\n Anna,Post-doctoral researcher,postdoctoral_assistant,166495,0.30,\nSacha,Adjoint doctoral,doctoral_assistant,173934,0.90,\nC̩cile,Trainee,trainee,208982,0.10,\nLaurence,Assistant extern,other,240502,0.80,';
export const csvEquipmentContent =
  'name,equipment_class,sub_class,active_usage_hours_per_week,standby_usage_hours_per_week,note\nTEST,Centrifugation,Mini centrifuges,12,3,';
export const csvExternalCloudContent =
  'service_type,provider,spent_amount,currency,note\nstorage,Huawei,3556,,';
export const csvExternalAIContent =
  'provider,usage_type,requests_per_user_per_day,user_count,note\nGoogle,text,1-5 times per day,5,';
export const csvProcessesContent =
  'category,subcategory,quantity,note\nCH4,,65,';
export const csvPurchaseContent =
  'name,supplier,quantity,total_spent_amount,currency,purchase_institutional_code,purchase_institutional_description,purchase_additional_code,note\nGeoStudio Classroom Academic Bundle,Bentley Systems International Ltd,1.0,1077.00,usd,A,,IB71,';
