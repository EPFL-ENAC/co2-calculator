      ...
      <div class="q-mt-xl q-mx-lg">
        ...
        >
          <template #body="props">
            ...
            >
              ...
              <q-td key="documentation" :props="props">
                <q-btn
                  icon="o_article"
                  color="grey-4"
                  text-color="primary"
        ...
        <div>
          ...
          <h2 class="text-h3 q-mt-lg q-mb-sm">
            {{ $t('documentation_editing_calculator_co2_documentation_title') }}
          </h2>
          <p class="text-body1 q-mb-xl">
            {{
              $t(
          ...
          <h2 class="text-h3 q-mb-sm">
            {{
              $t('documentation_editing_calculator_service_documentation_title')
            }}
          </h2>
          <p class="text-body1 q-mb-xl">
            {{
