...
function downloadCSV() {
  ...
  const rows = props.units
    .map(
      (u) =>
        `${u.unit},${u.affiliation},${u.principal_user},${u.last_update},${u.completion_counts.validated},${u.completion_counts.in_progress},${u.completion_counts.default},${u.outlier_values}`,
    )
    .join('\n');
