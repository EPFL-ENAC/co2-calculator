...
## [1.4.2](https://github.com/EPFL-ENAC/co2-calculator/compare/v1.0.7...v1.4.2) (2026-08-25)
...
* Revert "fix: use py3 tuple syntax in fte except clause (#1922)" ([ab56853](https://github.com/EPFL-ENAC/co2-calculator/commit/ab5685339375810525edf204c2366c6f578e365b)), closes [#1922](https://github.com/EPFL-ENAC/co2-calculator/issues/1922)
# [1.4.1](https://github.com/EPFL-ENAC/co2-calculator/compare/039c73f...402e37d) (2026-08-24)
...
# [1.3.2](https://github.com/EPFL-ENAC/co2-calculator/compare/60fa63d...b6e783d) (2026-08-14)
...
**Also shipped across 1.3.1 → 1.3.2** (these interim versions were never
tagged, so their content folds into this entry)

* Data-entry permissions became provenance-aware (#951): each field now
  carries who is allowed to edit it depending on where the value came from
  (manual entry, CSV import, API sync), Headcount's SCIPER became editable
  after creation, and table cells respect the new policy for editing and
  deleting rows.
* `/healthz` and `/ready` do zero I/O by reading a background DB-connectivity
  poller instead of hitting the database inline on every check, and
  `/health/deps` returns a real 503 on a genuine dependency failure (#2049).
* The first tracks of the backend-compute-performance effort landed here
  already: `/ready` bounded and job dispatch split off API pods, and an N+1
  fixed in `_recalculate_report_emissions` (#2050, Tracks A/B — the bulk of
  that effort is in 1.4.0, see below).
* Planner UI rounded out: a header info tooltip, contextual module
  tooltips, a Headcount students row, an emission-types print report,
  private year-by-year plans, snapshots hidden for grant viewers, and
  Explorer reusing the Headcount planner layout (#1153, #1919, #1935,
  #1957, #1977, #1983, #2035, #2039, #2070).
...
* Revert "fix: use py3 tuple syntax in fte except clause (#1922)" ([ab56853](https://github.com/EPFL-ENAC/co2-calculator/commit/ab5685339375810525edf204c2366c6f578e365b)), closes [#1922](https://github.com/EPFL-ENAC/co2-calculator/issues/1922)
# [1.2.0](https://github.com/EPFL-ENAC/co2-calculator/compare/6caf87a...60fa63d) (2026-07-29)
